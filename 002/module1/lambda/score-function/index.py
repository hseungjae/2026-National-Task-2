...
def save_student(table, row):
    ...
    table.put_item(Item={
        ...
        "korean": Decimal(str(int(row["korean"].strip()))),
        "english": Decimal(str(int(row["english"].strip()))),
        "math": Decimal(str(int(row["math"].strip()))),
        "science": Decimal(str(int(row["science"].strip()))),
        "history": Decimal(str(int(row["history"].strip()))),
